...
// Mock SOLO de Instagram y Facebook: WhatsApp queda limpio para las
// conversaciones reales (Cloud API) que entran vía WHATSAPP_INCOMING.
...
// Métricas demo del dashboard (las que no se pueden calcular del store).
