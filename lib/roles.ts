...
export type ModuleId = "bandeja" | "contactos" | "interno" | "redes" | "dashboard" | "llamadas" | "agentes" | "settings";
...
const TODO: ModuleId[] = ["bandeja", "contactos", "interno", "redes", "dashboard", "llamadas", "agentes", "settings"];
